...
t += 1; n += H.check("PT-329201 relaxes after CCW restored",    pt2 < pt1 - PT_MOVE,     f"PT {pt1} -> {pt2}")
...
assert pt2 < pt1 - PT_MOVE,      "PT-329201 must relax toward design after CCW restored"
